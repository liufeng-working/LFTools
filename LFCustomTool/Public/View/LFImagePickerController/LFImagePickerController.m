...
{
    if ([self.pickerDelegate respondsToSelector:@selector(imagePickerController:didFinishPickingAssets:publics:)]) {
        [self.pickerDelegate imagePickerController:self didFinishPickingAssets:self.assets publics:self.publics];
    }
}
