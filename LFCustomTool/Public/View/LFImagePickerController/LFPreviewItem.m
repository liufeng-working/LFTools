...
@interface LFPreviewItem ()<UIScrollViewDelegate>
...
{
    if (!_playerBtn) {
        UIImage *normal = [UIImage imageNamed:@"lf_videoPlayer_normal"];
        UIImage *highlighted = [UIImage imageNamed:@"lf_videoPlayer_highlighted"];
...
- (void)handleTap
{
    if ([self.delegate respondsToSelector:@selector(previewItemDidClick:)]) {
        [self.delegate previewItemDidClick:self];
    }
}
...
- (void)playerBtnClick:(UIButton *)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(previewItemDidClickPlayerButton:)]) {
        [self.delegate previewItemDidClickPlayerButton:self];
    }
}
